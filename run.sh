...
roslaunch widowx_controller widowx_rs.launch ${video_stream_provider_string} camera_connector_chart:=${camera_connector_chart} ${python_node_string} ${camera_string}
